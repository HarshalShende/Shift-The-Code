 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://rpc.soap.com/", wsdlLocation = "http://localhost:7779/ws/hello?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://rpc.soap.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://rpc.soap.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rpc.soap.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
